                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                <li class="nav-item">
                                    ...
                                    <div class="nav-link">
                                        <a class="link <?php echo ($currentPage == "dashboard") ? 'active' : '' ?>" href="dashboard.php">Home</a>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="nav-link">
                                        <a class="link <?php echo ($currentPage == "admin-booking") ? 'active' : '' ?>" href="admin-booking.php">Bookings</a>
                                    </div>
                                </li>
                                <li class="nav-item">
